...
## Need to install Thorium before removing Firefox ##
#####################################################
...
if [ ! -d $HOME/Applications/bitwarden ]; then
  mkdir $HOME/Applications/bitwarden
fi
wget https://github.com/bitwarden/clients/releases/download/desktop-v2024.4.1/Bitwarden-2024.4.1-x86_64.AppImage -P $HOME/Applications/bitwarden
chmod +x $HOME/Applications/bitwarden/Bitwarden-2024.4.1-x86_64.AppImage

## Download desktop icon
wget https://github.com/bitwarden/brand/blob/main/icons/512x512.png -P $HOME/Applications/bitwarden

## create the startmenu entry
cat << EOF > $HOME/Applications/bitwarden/Bitwarden.desktop
[Desktop Entry]
Name=Bitwarden
GenericName=Bitwarden
Exec=$HOME/Applications/bitwarden/Bitwarden-2024.4.1-x86_64.AppImage
Terminal=false
Icon=$HOME/Applications/bitwarden/512x512.png
Type=Application
Categories=Internet;
Version=2024.4.1
EOF

sudo cp $HOME/Applications/bitwarden/Bitwarden.desktop /usr/share/applications/bitwarden.desktop
#######################
## Generate ssh Keys ##
#######################
if [ -d ~/.ssh/ ]; then
...
## Add the caffeine-indicator to startup apps
